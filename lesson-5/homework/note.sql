...
--Task 5
select distinct FirstName, City from Customers
--TASK 6
select *, 
...
--TASK 7
select *,
IIF(StockQuantity > 100, 'Yes', 'No') from Products_Discounted
--                        MEDIUM-LEVEL TASKS
--TASK 8
select ProductName from Products
UNION
...
--TASK 10
select *,
IIF(Price > 1000, 'Expensive', 'Affordable') from Products
--TASK 11
...
case when Quantity = 1 then '3%'
	 ...
	 else '7%' end as DiscoundPercentage
from Orders
