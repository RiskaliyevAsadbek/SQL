...
SELECT Departments.DepartmentName,Employees.EmployeeID FROM Departments
...
SELECT Students.StudentID, Courses.CourseName FROM Courses
CROSS JOIN Students
...
SELECT Orders.OrderID FROM Payments
INNER JOIN Orders
...
--TASK 17 Using Employees and Departments tables, get the Department Name for each employee.
SELECT Employees.Name, Departments.DepartmentName FROM Employees
INNER JOIN Departments
ON Employees.DepartmentID = Departments.DepartmentID
